...
var isWindowInstance = function(win) {
    return "window" === Object.prototype.toString.call(win).replace(/^\[object |\]$/g, "").toLowerCase();
};
...
+function(unsafeWindow, window, jMod) {
...
}.call(this, "undefined" !== typeof unsafeWindow && unsafeWindow.top && isWindowInstance(unsafeWindow) ? unsafeWindow : "undefined" !== typeof window && window.top && isWindowInstance(window) ? window : this, window, function(initStart, $, console, window, unsafeWindow, _undefined, undefined) {
    function jMod() {
    ...
    DefineLockedProp("build_time", "1422634243000");
    ...
    Object.defineProperty(jMod.API.localStorage, "stor", {
        get: function() {
            return localStorage ? localStorage : window.localStorage ? window.localStorage : unsafeWindow.localStorage;
        },
        enumerable: false
    });
    ...
    Object.defineProperty(jMod.API.sessionStorage, "stor", {
        get: function() {
            return sessionStorage ? sessionStorage : window.sessionStorage ? window.sessionStorage : unsafeWindow.sessionStorage;
        },
        enumerable: false
    });
    ...
    return jMod;
}(window && "undefined" !== typeof window.performance ? window.performance.now() : 0, "undefined" !== typeof jQuery ? jQuery : void 0, console, window, "undefined" !== typeof unsafeWindow && unsafeWindow.top && isWindowInstance(unsafeWindow) ? unsafeWindow : "undefined" !== typeof window && window.top && isWindowInstance(window) ? window : this, "undefined"));
